...
describe("LoginGuard", () => {
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        ...
        RouterTestingModule.withRoutes([{ path: "403", component: ErrorPageComponent }])
      ],
  ...
  it("returns payload from decoding a valid JWT", inject([LoginGuard], (guard: LoginGuard) => {
    localStorage.setItem("token", process.env.TEST_JWT);
...
describe("AdminGuard", () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [AdminGuard, { provide: LoginGuard, useValue: loginGuard }]
    });
  });
...
describe("AccountingGuard", () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [AccountingGuard, { provide: LoginGuard, useValue: loginGuard }]
    });
  });
...
describe("DeluxeGuard", () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [DeluxeGuard, { provide: LoginGuard, useValue: loginGuard }]
    });
  });
